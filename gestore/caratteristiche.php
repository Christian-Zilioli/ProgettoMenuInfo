...
//suddivisione pagine
try{
    $sql = "SELECT COUNT(*) FROM caratteristiche";
...
//caratteristiche
try {
    $sql = 'SELECT * FROM caratteristiche WHERE 1=1';
                    ...
                    <tbody>
                        <?php foreach ($caratteristiche as $c): ?>
                            <tr>
                                ...
                                <td><a href="confermaElimina.php?id=<?= $c["id_caratteristica"] ?>"><i class="fa fa-trash w3-text-red"></i></a></td>
                                <td><a href="confermaModifica.php?id=<?= $c["id_caratteristica"] ?>"><i class="fa fa-edit w3-text-blue"></i></a></td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
                </table>
