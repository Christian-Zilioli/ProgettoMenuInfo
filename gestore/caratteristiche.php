...
<body>
    ...
    <div class="w3-bar w3-light-grey">
        <a href="gestione_caratteristiche.php" class="w3-bar-item w3-button"><i class="fa fa-plus"></i> Inserisci</a>
    </div>
    ...
    <div class="w3-bar w3-light-grey w3-card w3-margin-bottom">
        ...
        <div class="w3-panel w3-blue w3-card-4">
            <p>
                <?php if ($num_record > 0): ?>
                    <i class="fa fa-info-circle"></i> Nell'archivio sono presenti <strong><?= $num_record ?></strong> caratteristiche.
                <?php else: ?>
                    <i class="fa fa-exclamation-triangle"></i> Non ci sono caratteristiche memorizzate in archivio
                <?php endif ?>
            </p>
        </div>
                    ...
                    <tbody>
                        <?php foreach ($caratteristiche as $c): ?>
                            <tr>
                                ...
                                <td><a href="elimina.php?id=<?= $c["id_caratteristica"] ?>&tabella=caratteristiche"><i class="fa fa-trash w3-text-red"></i></a></td>
                                <td><a href="gestione_caratteristiche.php?id=<?= $c["id_caratteristica"] ?>"><i class="fa fa-edit w3-text-blue"></i></a></td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
                </table>
