...
try {
    ...
    $msgErrore["allergeni"] = $e->getMessage();
}
?>
<!DOCTYPE html>
<html lang="it">
...
<body>
    <div class="w3-container bg-pizza w3-padding-16">
        <h2 class="w3-xlarge w3-margin-0">
            <i class="fa fa-exclamation-triangle"></i> Gestione Allergeni Pizzeria da Paggi
        </h2>
    </div>
    ...
    <div class="w3-bar w3-white w3-card w3-margin-bottom">
        ...
        <div class="w3-right">
            <a href="gestione_allergeni.php" class="w3-bar-item w3-button bg-basil w3-padding-16">
                <i class="fa fa-plus"></i> Inserisci Allergene
            </a>
        </div>
    </div>
    ...
    <div class="w3-content" style="max-width:1200px">
        ...
        <div class="w3-container w3-padding-16 bg-cream w3-card w3-round-large w3-margin">
            <form method="GET">
                <h4 class="text-pizza w3-border-bottom w3-padding-16"><i class="fa fa-search"></i> Filtra Allergeni</h4>
                <div class="w3-row-padding">
                    <div class="w3-half">
                        <label>Nome Allergene</label>
                        <input class="w3-input w3-border w3-round" type="text" name="nome" placeholder="Es: Glutine, Lattosio..." value="<?= $_GET['nome'] ?? '' ?>">
                    </div>
                </div>
        ...
        <div class="w3-container">
            <div class="w3-panel w3-white w3-card w3-border-left w3-border-red">
                <p>
                    <?php if ($num_record > 0): ?>
                        <i class="fa fa-info-circle text-pizza"></i> Nell'archivio sono presenti <strong><?= $num_record ?></strong> allergeni.
                    <?php else: ?>
                        <i class="fa fa-exclamation-triangle w3-text-red"></i> Non ci sono allergeni memorizzati.
                    <?php endif ?>
                </p>
            </div>
        </div>
                        ...
                        <tbody>
                            <?php foreach ($allergeni as $a): ?>
                                <tr>
                                    ...
                                    <td class="w3-center">
                                        <a href="gestione_allergeni.php?id=<?= $a["id_allergene"] ?>" title="Modifica">
                                            <i class="fa fa-edit w3-text-blue"></i>
                                        </a>
                                    </td>
                                    <td class="w3-center">
                                        <a href="elimina.php?id=<?= $a["id_allergene"] ?>&tabella=allergeni" title="Elimina" onclick="return confirm('Sei sicuro di voler eliminare questo allergene?')">
