...
<body>
    ...
    <div class="w3-bar w3-light-grey w3-card w3-margin-bottom">
        ...
        <div class="w3-panel w3-blue w3-card-4">
            <p>
                <?php if ($num_record > 0): ?>
                    <i class="fa fa-info-circle"></i> Nell'archivio sono presenti <strong><?= $num_record ?></strong> allergeni.
                <?php else: ?>
                    <i class="fa fa-exclamation-triangle"></i> Non ci sono allergeni memorizzat in archivio
                <?php endif ?>
            </p>
        </div>
